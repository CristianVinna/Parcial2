# Pede para o usuário o capital inicial (valor investido)
capital = float(input("Digite o capital (R$): "))

# Pede ao usuário a taxa de juros (em porcentagem)
taxa = float(input("Digite a taxa de juros (%): "))

# Pede ao usuário o tempo (em períodos, ex: meses ou anos)
...
# Mostra o valor dos juros calculados
